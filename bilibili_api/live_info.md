...
protocol	str	直播协议	必要	0：http_stream
1：http_hls
可多选, 使用英文逗号分隔
format	str	格式	必要	0：flv
1：ts
2：fmp4
可多选, 使用英文逗号分隔
codec	str	编码格式	必要	0：AVC
1：HEVC
可多选, 使用英文逗号分隔
qn	num	清晰度编码		默认150
清晰度代码
...
pwd_verified	bool	是否通过密码验证	当encrypted为true时才有意义
